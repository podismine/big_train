...
class Task1Data(data.Dataset):
    ...
    def __getitem__(self,index):
        ...
        if self.mask_way == 'mask':
            ...
            slices = [random_timeseries(img,self.time_len).T, random_timeseries(img,self.time_len).T]
        else:
...
class Task3Data(data.Dataset):
    ...
    def __init__(self, shuffle_seed=42,is_train = True, is_test = False):
        ...
        self.root = "/userhome/run1_abide1"

        self.df = pd.read_csv("/userhome/clean_abide1_train.csv")
