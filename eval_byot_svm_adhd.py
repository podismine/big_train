from network_dataset_adhd import Task3Data
import torch
import sys
import yaml
import numpy as np
...
train_loader = DataLoader(train_dataset, batch_size=batch_size,
                          num_workers=6, drop_last=False, shuffle=True)
...
with open(f"/userhome/timeinvariant/TimeInvariant/adhd_final_{res_path}.txt", 'a') as f:
